...
app.use(cors({
    ...
    origin: ["http://localhost:5173", "http://127.0.0.1:5173", "http://localhost:5174", "http://127.0.0.1:5174", "https://sociodeals.netlify.app","https://sociodeals.com", "https://www.sociodeals.com", "https://adminsociodeals.netlify.app"],
...
app.use("/api/admin/products", verifyAdmin, require("./routes/adminProductRoutes"));
app.use(
  "/api/admin/sales",
  verifyAdmin,
  require("./routes/adminSaleRoutes")
);
